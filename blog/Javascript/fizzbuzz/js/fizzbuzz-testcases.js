/**
* Testcases for FizzBuzz in javascript
*
...
test("test getFizzBuzzStatements_switch()", function(){
    var fn = getFizzBuzzStatements_switch;
    deepEqual( fn(100), expected );
});
test("test getFizzBuzzStatements_ternary()", function(){
    var fn = getFizzBuzzStatements_ternary;
    deepEqual( fn(100), expected );
});